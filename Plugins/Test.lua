...
function BigWigsTest:BigWigs_Test()
    ...
    self:TriggerEvent("BigWigs_StartBar", self, "Combat", 16, "Interface\\Icons\\Inv_Hammer_Unique_Sulfuras")
    ...
    --self:TriggerEvent("BigWigs_StartCounterBar", self, "CounterBar Test", 10, "Interface\\Icons\\Spell_Shadow_Charm")
