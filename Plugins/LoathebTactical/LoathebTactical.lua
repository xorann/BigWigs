...
L:RegisterTranslations("enUS", function() return {
	...
	-- SPORE
	["Loatheb Tactical"] = true, -- frame title	
	
	["Announce order"] = true,
	["You are next!"] = true,
	["Next Spore Group"] = true,
...
L:RegisterTranslations("deDE", function() return {
	-- SPORE
	["Loatheb Tactical"] = "Loatheb Taktik",
	
	["Announce order"] = "Reihenfolge bekanntgeben",
	["You are next!"] = "Du bist der Nächste!",
	["Next Spore Group"] = "Nächste Sporengruppe",
} end )
...
local syncName = {
	...
	listUpdate = "LTListUpdate",
	requestUpdate = "LoathebTacticalRequestUpdate",
}
...
function module:OnEngage()
	...
	module:OnEngageSpore()
end

-- called after boss is disengaged (wipe(retreat) or victory)
function module:OnDisengage()
	self:CancelScheduledEvent("bwloathebtacticalspore")

	module:OnDisengageSpore()
end

function module:OnDisable()
	module:OnDisableSpore()
end
...
function module:BigWigs_RecvSync(sync, rest, nick)
	...
	module:BigWigs_RecvSync_Spore(sync, rest, nick)
end
