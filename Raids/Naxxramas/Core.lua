...
BigWigs.bossmods.naxx.sapphiron = "Sapphiron"
...
BigWigs:ModuleDeclaration(BigWigs.bossmods.naxx.sapphiron, "Naxxramas")
BigWigs:ModuleDeclaration(BigWigs.bossmods.naxx.kelthuzad, "Naxxramas")
